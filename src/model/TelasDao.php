	...
	class TelasDao {
		...
		public function read($where, $order, $wp) {
			...
			while ($row = $result->fetch_assoc()) {
				...
				$this->setResponse($line, "telas.tela.format.json", modelDoubleQuotesJson($row["telas.tela"]));
				...
				$this->setResponse($line, "telas.identificador.format.json", modelDoubleQuotesJson($row["telas.identificador"]));
