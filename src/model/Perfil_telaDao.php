	...
	class Perfil_telaDao {
		...
		public function setRead($where, $order) {
			...
			$this->sql = "SELECT " . $this->read . ", " . $perfisDao->read . ", " . $permissoesDao->read . ", " . $telasDao->read . 
					...
					($this->getWhere() == "" ? " WHERE perfil_tela.perfil = perfis.id AND perfil_tela.permissao = permissoes.id AND perfil_tela.tela = telas.id" : $this->getWhere()) . 
					" AND perfil_tela.perfil = perfis.id AND perfil_tela.permissao = permissoes.id AND perfil_tela.tela = telas.id" . $this->getOrder();
		}
