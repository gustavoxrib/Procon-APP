<?php
	...
	class PermissoesDao {
		...
		public $read = 
				...
				, permissoes.cor AS \"permissoes.cor\"
				";
		...
		public function read($where, $order, $wp) {
			...
			while ($row = $result->fetch_assoc()) {
				...
				$this->setResponse($line, "permissoes.permissao.format.json", modelDoubleQuotesJson($row["permissoes.permissao"]));
				...
				$this->setResponse($line, "permissoes.cor", $row["permissoes.cor"]);
